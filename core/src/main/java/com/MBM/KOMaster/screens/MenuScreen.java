...
public class MenuScreen implements Screen {
    ...
    private final String[] menuOptions = {"Juego local", "Juego en linea", "Opciones", "Salir"};
    ...
    public void show() {
        ...
        // Reproducir música del menú solo si no está sonando ya
    ...
    private void handleInput() {
        ...
        if (Gdx.input.isKeyJustPressed(Keys.ENTER) || Gdx.input.isKeyJustPressed(Keys.SPACE)) {
            switch (menuOptions[selectedOption]) {
                case "Juego local":
                    dispose();
                    game.setScreen(new com.MBM.KOMaster.screens.CharacterSelectScreen(game));
                    break;
                case "Juego en linea":
                    System.out.println("Juego en línea no implementado.");
                    break;
                case "Opciones":
                    dispose();
    ...
    public void dispose() {
        ...
        // LAS FUENTES NO SE DISPOLEAN ACÁ, LAS MANEJA Principal
    }
}
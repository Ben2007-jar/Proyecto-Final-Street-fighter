...
/**
 * Personaje Amigo.R - Puede ser controlado por cualquier jugador
 */
public class Fighter1 extends Character {
    ...
    public Fighter1(float x, float y, int health, InputController controller) {
        super(x, y, health, controller);
        loadAnimations();
    }

    private void loadAnimations() {
        Texture walkSpriteSheet = new Texture("images/fighter1_walk.png");
        ...
        Texture attackSpriteSheet = new Texture("images/fighter1_hit.png");
        ...
        Texture kickSpriteSheet = new Texture("images/fighter1_hit.png");
        ...
        Texture blockWalkSpriteSheet = new Texture("images/fighter1_walkblock.png");
    ...
    public float getAttackRange() {
        return 210f; // Rango de golpe normal
    }

    @Override
    public float getKickRange() {
        return 230f; // NUEVO: Rango de patada (un poco más largo)
    }
}